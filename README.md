...
1. SRT Macro 크롬 확장 프로그램을 설치합니다.
2. [SR](https://etk.srail.co.kr/main.do) 홈페이지에 접속해 로그인을 합니다.
3. 로그인 후, 원하는 날짜와 시간을 선택하고 '조회하기'를 누르면 ![매크로시작](https://raw.githubusercontent.com/meeeejin/srtmacro/master/images/btn_start.png) 버튼이 생긴 것을 확인할 수 있습니다. 이 때, 원하는 열차의 **매크로 체크박스**를 누르고 **매크로 시작** 버튼을 누르면 프로그램이 시작됩니다.
